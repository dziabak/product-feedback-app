...
const FeedbackFormLayout = ({ children }: { children: JSX.Element }) => {
	...
	return (
		<section
			className={clsx(
				"fixed top-0 left-0 z-10 w-full h-full cursor-pointer bg-c-dark-blue/50 backdrop-blur transition-all duration-300",
			...
			<div className="flex flex-col items-center justify-center w-full h-full">
				<div
					...
					<img src={renderedIcon} alt="" className="absolute top-0 -mt-8 w-14 h-14" />
					{children}
				</div>
			</div>
		</section>
